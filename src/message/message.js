...
/**
 * See RFC 3261 Section 7 for information about SIP messages.
 * In regards to the ordering of headers @see Section 7.3.1:
...
/**
 * Adds a raw header name value pair to the message. Each value
 * indicates a unique instance of the header. Most headers can combine
 * values into a comma separated list in a single header field,
 * however there are exceptions.  See the excerpt above from 7.3.1.
...
jssip.message.Message.prototype.addRawHeader = function(name, value) {
  ...
  this.rawHeaders_[name].push(value);
};
...
//TODO(erick): eventually this /may/ be the place to convert from
//shortnames to long form names? I'm not really sure yet.
/**
